...
function Notification() {
  ...
  return (
    <div className='w-screen h-[100vh] bg-[#f3f2ec] pt-[100px] px-[20px] flex flex-col items-center gap-[40px]'>
        <Nav/>
        <div className='w-full h-[100px] bg-[white] shadow-lg rounded-lg flex items-center p-[10px] text-[22px] text-gray-600 justify-between'>
            ...
            {notificationData.length>0 && <button className='min-w-[100px] h-[40px] rounded-full border-2 border-[#ff2d2d] text-[#ff2d2d]' onClick={handleClearAllNotification}>Clear All</button>}
        ...
        <div className='w-[100%] max-w-[900px] bg-white shadow-lg rounded-lg flex flex-col gap-[20px] min-h-[100px]'>
            ...
            <div className='w-full min-h-[100px] flex justify-between items-center border-b-2 border-b-gray-200' key={index}>
                ...
                <div className='flex justify-center items-center gap-[10px]'>
                    ...
                    {noti.relatedPost && <div className='flex items-center gap-[10px] ml-[80px] h-[70px] overflow-hidden'>
