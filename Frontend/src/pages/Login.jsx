 ...
 let [show,setShow] = useState(false)
  ...
  return (
    <div className='w-full h-screen bg-[white] flex flex-col items-center justify-start gap-[10px]'>
      ...
      <form className='w-[90%] max-w-[400px] h-[600px] md:shadow-2xl flex flex-col justify-center p-[15px] gap-[10px]' onSubmit={handleSignIn}>
        ...
        <button className='w-[100%] h-[50px] rounded-full bg-[#1d60fd] mt-[40px] text-white ' disabled={loading}>{loading?"Loading...":"Sign In"}</button>

        <p className='text-center cursor-pointer' onClick={()=>navigate("/signup")}>Want to create a new account? <span className='text-[#1d60fd] ' >Sign Up</span></p>
